#!/usr/bin/env python3
"""
Minimal script to seed default story categories
"""
...
from core.core.database import SessionLocal, Base
from sqlalchemy import Column, Integer, String, DateTime, BigInteger
from sqlalchemy.sql import func
import re
import uuid

# Define StoryCategory model locally to avoid import issues
...
def create_category_minimal(db, name: str, description: str = None):
    """Create category with minimal imports"""
...
def seed_categories():
    ...
    try:
        for category_data in default_categories:
            try:
                category = create_category_minimal(
                    db, 
                    category_data["name"], 
